...
{/*
  ...
  fParticleGun->SetParticleMomentumDirection(G4ThreeVector(0.,0.,-6.*cm));
...
// 
 ...
 // G4double d_lame = 12*mm ;
  
    //m_particleGun->SetParticlePosition(G4ThreeVector(0.,e_bas/2-h_int/2+d_lame-e_lame/2,0.));
