...
G4VPhysicalVolume* DetectorConstruction::DefineVolumes()
{
 ...
 // new G4PVPlacement(rot_scint,  // no rotation
  ...
  fGap_under_the_Sample_LV = new G4LogicalVolume( Gap_under_the_Sample_S, fGasMaterial,"Gap_under_the_Sample_LV");
  ...
  auto Gap_under_the_Sample_PV = new G4PVPlacement(0,	//no rotation
    ...
    fGap_under_the_Sample_LV,				//its logical volume
 ...
 //        << G4endl;
  ...
  fGap_under_the_Sample_LV ->SetVisAttributes(Gap_under_the_Sample_Att); 
...
void DetectorConstruction::ConstructSDandField()
{
  ...
  G4String trackerChamberSDname = "B2/ProCom/TrackerSD";
  ...
  auto aGapSD = new TrackerSD("B2/ProCom/GapSD", "GapHitsCollection");
  G4SDManager::GetSDMpointer()->AddNewDetector(aGapSD);
  SetSensitiveDetector( fGap_under_the_Sample_LV,  aGapSD );
